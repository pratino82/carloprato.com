      ...
      <div className="page-shell">
        ...
        <section className="section" id="other-writing">
          ...
          <ol className="publication-list">
            ...
            <li data-number="01"><p><a href="https://www.dropbox.com/scl/fi/04b5k0vj4up01k35a294u/Adam-S.pdf?rlkey=sh51sp9398obv63gintt4ourj&dl=0" target="_blank" rel="noopener">Il Valore della Democrazia: Breve Saggio di Adam Przeworski</a> <span className="item-note">[Italian translation]</span></p></li>
          </ol>
        </section>
      </div>
    </main>
